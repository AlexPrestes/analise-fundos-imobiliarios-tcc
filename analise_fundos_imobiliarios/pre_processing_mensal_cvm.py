...
pre_processing_mensal = {
    ...
    'Publico_Alvo': [
        r'(INVESTIDORES\ EM\ GERAL|INVESTIDOR\ PROFISSIONAL|INVESTIDOR\ QUALIFICADO\ E\ PROFISSIONAL|INVESTIDOR\ QUALIFICADO)',
        str,
    ],
    ...
    'Mandato': [
        r'(Renda|Desenvolvimento\ para\ Venda|Desenvolvimento\ para\ Renda|Híbrido|Títulos\ e\ Valores\ Mobiliários)',
        str,
    ],
    'Segmento_Atuacao': [
        r'(Shoppings|Híbrido|Lajes\ Corporativas|Outros|Logística|Hospital|Títulos\ e\ Val\.\ Mob\.|Hotel|Residencial)',
        str,
    ],
